...
<head>
    ...
    <style>
        ...
        .comment-input {
            display: flex; /* 텍스트 입력창과 버튼을 가로로 배치 */
            align-items: flex-start; /* 수직 방향에서 입력창과 버튼 상단 정렬 */
            gap: 10px; /* 텍스트 입력창과 버튼 사이 간격 */
        }

        .comment-input textarea {
            flex: 1; /* 텍스트 입력창이 가로 공간의 대부분을 차지 */
            height: 50px; /* 입력창 높이 */
            padding: 10px;
            font-size: 14px;
            border: 1px solid #ddd;
        ...
        .comment-input button {
            ...
            color: white;
            cursor: pointer;
            align-self: flex-start; /* 버튼을 입력창의 상단과 맞춤 */
        }
