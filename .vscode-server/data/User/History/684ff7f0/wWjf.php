...
// 게시판 유형 확인 (자유게시판인지 홍보게시판인지)
$board_name = $post['POST_NAME'];
...
<body>
    ...
    <div class="container">
        <!-- 게시판 이름 표시 -->
        <div class="board-name" style="text-align: center; margin-bottom: 20px; font-size: 30px; font-weight: bold; color: #333333;">
