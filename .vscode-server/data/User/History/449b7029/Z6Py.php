...
<head>
    ...
    <title>FIFA ONLINE 4 page</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="tab-contents">
        <div class="tab-content" id="info">
            ...
            <img src="img/피파/피파 대회정보.png" alt="대회안내" class="bracket-image">
        </div>
        <div class="tab-content" id="date">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">신청 및 경기일정</h1>
            </div>
            <img src="img/피파/피파 일정.png" alt="일정" class="bracket-image">
        </div>
        <div class="tab-content" id="rule">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">대회 규정</h1>
            </div>
            <img src="img/피파/피파 규정1.png" alt="규정" class="bracket-image">
        </div>
        <div class="tab-content" id="bracket">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">대진표</h1>
            </div>
            <img src="img/피파/피파 대진표.png" alt="대진표" class="bracket-image">
        </div>
        <div class="tab-content" id="prizes">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">상품</h1>
            </div>
            <img src="img/피파/피파 상품.png" alt="상품" class="bracket-image">
        </div>
    </div>
