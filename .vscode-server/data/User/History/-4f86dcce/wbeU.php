...
<body>
    ...
    <div class="slideshow-container">
        <div class="overlay">
            <img src="img/로고/Hongvox.png" alt="로고">
    ...
    <div class="slider-container">
        <div class="slider" id="slider">
            <?php
            include 'media.php'; // 활동 내역 데이터 포함
            $activities = getActivityData(); // 활동 내역 데이터 가져오기
            ...
            foreach ($activities as $activity) {
                ...
                <div class='slide'>
                    ...
                    <div class='slide-title'>{$activity['title']}</div>
                </div>
                ";
            }
            ?>
    ...
    <script>
        ...
        nextButton.addEventListener('click', () => {
            if (currentIndex < slides.length - 1) {
                ...
                currentIndex = 0; // 마지막 슬라이드에서 첫 슬라이드로 이동
            }
            updateSlider();
        });
        ...
        prevButton.addEventListener('click', () => {
            if (currentIndex > 0) {
                ...
                currentIndex = slides.length - 1; // 첫 슬라이드에서 마지막 슬라이드로 이동
            }
            updateSlider();
        });
