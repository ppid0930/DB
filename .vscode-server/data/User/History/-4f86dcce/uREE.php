...
<body>
    ...
    <div class="activity-list">
        <div class="activity-item">
            <img src="img/홍보/롤 홍보.png" alt="청주 샵PC방">
        ...
        <div class="activity-item">
            <img src="img/홍보/롤 홍보.png" alt="안양 모던PC방">
            <div class="activity-details">
                <h3>안양 모던PC방 | 우수 이스포츠 시설 소개</h3>
                <p>2024 이스포츠 동호인 대회</p>
                <span>2024-10-28</span>
            </div>
        </div>
        <div class="activity-item">
            <img src="img/홍보/롤 홍보.png" alt="뉴빈스">
            <div class="activity-details">
                <h3>뉴빈스가 간다 EP.3 | 2024 이스포츠 동호인 대회</h3>
                <p>2024 이스포츠 동호인 대회</p>
