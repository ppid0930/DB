...
<head>
    ...
    <style>
        * {
        ...
        .slideshow-container {
            width: 100%;
            height: 600px; /* 슬라이드 높이 */
            position: relative;
            overflow: hidden;
            background-color: #000; /* 빈 공간 배경색 */
        }
        ...
        .slides {
            ...
            object-fit: contain; /* 이미지 원본 비율 유지, 전체 표시 */
            object-position: center; /* 이미지를 컨테이너 중앙에 배치 */
            background-color: #000; /* 빈 공간을 채우는 배경색 */
        }
