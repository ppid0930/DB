...
// 게시글 가져오기
$write_sql = "
    SELECT NUM, WRITE_ID, CONTENT_NAME, USER_ID, TO_CHAR(CREATED_AT, 'YYYY-MM-DD HH24:MI:SS') AS CREATED_AT
    FROM (
        SELECT ROW_NUMBER() OVER (ORDER BY CREATED_AT ASC) AS NUM, -- 각 게시판 내 번호 부여
