...
<head>
    ...
    <title>League Of Legend page</title>
    ...
    <div class="tab-contents">
        <div class="tab-content" id="info">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">대회안내</h1>
            </div>
        ...
        <div class="tab-content" id="date">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">신청 및 경기일정</h1>
            </div>
            <img src="img/롤/롤 일정.png" alt="일정" class="bracket-image">
            <img src="img/롤/롤 일정2.png" alt="일정2" class="bracket-image">
            <div style="text-align: left; margin-top: 50px;">
                <h1 style="font-size: 30px; font-weight: bold;">경매 일정</h1>
            </div>
            <img src="img/롤/롤 일정3.jpg" alt="경매일정" class="bracket-image"> 
        </div>
        <div class="tab-content" id="rule">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">대회규정</h1>
            </div>
            <img src="img/롤/롤 규정1.jpg" alt="규정1" class="bracket-image">
            <img src="img/롤/롤 규정2.jpg" alt="규정2" class="bracket-image">
            <img src="img/롤/롤 규정3.jpg" alt="규정3" class="bracket-image">
            <img src="img/롤/롤 규정4.jpg" alt="규정4" class="bracket-image">
            <img src="img/롤/롤 규정5.jpg" alt="규정5" class="bracket-image">
            <img src="img/롤/롤 규정6.jpg" alt="규정6" class="bracket-image">
        </div>
        <div class="tab-content" id="bracket">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">대진표</h1>
            </div>
            <img src="img/롤/롤 대진표.png" alt="대진표" class="bracket-image">
        </div>
        <div class="tab-content" id="prizes">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">상품</h1>
            </div>
            <img src="img/롤/롤 상품.jpg" alt="상품" class="bracket-image">
        </div>
    </div>
