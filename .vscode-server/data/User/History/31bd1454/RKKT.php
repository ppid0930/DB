...
<body>
    ...
    <div class="tab-contents">
        ...
        <div class="tab-content" id="date">
            <div style="text-align: left; margin-top: 20px;">
                <h1 style="font-size: 30px; font-weight: bold;">신청기간</h1>
            </div>
        ...
        <div class="tab-content" id="rule">
            <div style="text-align: left; margin-top: 20px;">
                ...
                <img src="img/롤/롤 규정1.png" alt="규정1" class="bracket-image">
                <img src="img/롤/롤 규정2.png" alt="규정2" class="bracket-image">
                <img src="img/롤/롤 규정3.png" alt="규정3" class="bracket-image">
                <img src="img/롤/롤 규정4.png" alt="규정4" class="bracket-image">
                <img src="img/롤/롤 규정5.png" alt="규정5" class="bracket-image">
                <img src="img/롤/롤 일정6.png" alt="규정6" class="bracket-image">
            </div>
