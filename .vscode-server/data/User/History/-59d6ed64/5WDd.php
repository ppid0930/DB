...
<body>
    <?php include 'navbar_login.php'; ?> <!-- 네비게이션 바 포함 -->
    <div class="slideshow-container">
        <div class="overlay">
            <img src="img/logo2.png" alt="로고">
            <button onclick="location.href='register.html'">대회 참가하기</button>
        </div>
        <?php
        $imageDir = "img/";
        $images = glob($imageDir . "*.{jpg,jpeg}", GLOB_BRACE);
    ...
    <div class="content">
        ...
        <p>2024년 11월 16일(토) 오전 11시<br>HEC 우승자는 과연 누구일까?</p>
    </div>
    <div class="tournament-list">
        <?php
        $tournaments = [
            ["image" => "img/피파.jpeg", "title" => "HEC 2024 FC 온라인 대회", "location" => "과학기술대학", "date" => "2024-11-23 11:00"],
            ["image" => "img/리그오브레전드.jpg", "title" => "HEC 2024 LOL 대회", "location" => "과학기술대학", "date" => "2024-11-24 15:00"],
            ["image" => "img/배틀그라운드.jpg", "title" => "HEC 2024 배틀그라운드 대회", "location" => "과학기술대학", "date" => "2024-11-29 19:00"]
        ];
