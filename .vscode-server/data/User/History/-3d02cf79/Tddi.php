...
<body>
    ...
    <?php
        include 'media.php'; // media.php 파일 포함

        // 함수 호출로 $contents 데이터 가져오기
        $contents = getMediaContents();

        // 데이터를 동적으로 출력
        foreach ($contents as $content): ?>
            <div class="talent-item" data-content-id="<?php echo htmlspecialchars($content['number']); ?>">
                <!-- 책갈피 버튼 -->
                <div class="bookmark-icon" 
                    onclick="toggleBookmarkPopular(<?php echo htmlspecialchars($content['number']); ?>)">
                </div>
                <!-- 이미지 출력 -->
                <img src="<?php echo htmlspecialchars($content['image']); ?>" alt="<?php echo htmlspecialchars($content['title']); ?>">
                <!-- 번호 출력 -->
                <div class="content-number"><?php echo htmlspecialchars($content['number']); ?></div>
                <!-- 제목 출력 -->
                <div class="content-title"><?php echo htmlspecialchars($content['title']); ?></div>
                <!-- 설명 출력 -->
                <div class="content-url"><?php echo htmlspecialchars($content['url']); ?></div>
            </div>
