...
<head>
    ...
    body {
        ...
        align-items: center;
        height: 100vh;
        background: url('img/메인화면 및 배경/bg.jpeg') no-repeat center center;
...
<body>
    <div class="logotop-container">
        <a href="mainpage.php">
             <img src="img/VOX.png" alt="로고" class = "logotop-container img">
        </a>
    </div>
    <div class="login-container">
        ...
        <div class="logo-container">
            <a href="mainpage.php">
                <img src="img/VOX.png" alt="로고"class = "logo-container img"> <!-- 로고 이미지 파일 경로 -->
            </a>
        </div>
    </div>
