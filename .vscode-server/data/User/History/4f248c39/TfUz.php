...
// `WRITE_ID` 계산
$get_max_id_sql = "SELECT NVL(MAX(TO_NUMBER(WRITE_ID)), 0) + 1 AS NEXT_ID FROM WRITE WHERE POST_ID = :post_id";
$max_id_stmt = oci_parse($conn, $get_max_id_sql);
oci_bind_by_name($max_id_stmt, ":post_id", $post_id);
...
// 데이터 삽입
$insert_sql = "INSERT INTO WRITE (WRITE_ID, POST_ID, USER_ID, CONTENT_NAME, CONTENT, CREATED_AT) 
               VALUES (:write_id, :post_id, :user_id, :content_name, :content, SYSDATE)";
